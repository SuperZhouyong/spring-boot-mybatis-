...
/*
@Configuration
@MapperScan(basePackages = {"com.resumed.sqtwin.dao.mappertwo"}, sqlSessionFactoryRef = "sqlSessionFactoryBeanTwo")
public class MybatisConfigurerTwo {
    private static final String TAG = "MybatisConfigurerTwo";
    private final Logger logger = LoggerFactory.getLogger(MybatisConfigurerTwo.class);
